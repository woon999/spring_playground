# Spring 
### spring-core
- [spring-core](https://github.com/loosie/spring_practice/tree/master/spring-theory/spring-core)
### spring-aop
...
### spring-security
- [securty-oauth 로그인](https://github.com/loosie/spring_practice/tree/master/spring-security/spring-security-jwt)
- [security-jwt 로그인](https://github.com/loosie/spring_practice/tree/master/spring-security/spring-security-oauth2)
### spring-docker
- [spring-docker (docker, docker-compose)](https://github.com/loosie/spring_practice/tree/master/spring-docker)
...
- [dot_study - jpa기반 스터티 모임 관리 웹 애플리케이션](https://www.inflearn.com/course/%EC%8A%A4%ED%94%84%EB%A7%81-JPA-%EC%9B%B9%EC%95%B1/dashboard)
...
### Read Spring Book
- [Spring in Action 5](http://www.kyobobook.co.kr/product/detailViewKor.laf?mallGb=KOR&ejkGb=KOR&barcode=9791190665186)
- [토비 스프링 3.1 v1~2 (-ing)](http://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9788960773431&orderClick=LEa&Kc=)
